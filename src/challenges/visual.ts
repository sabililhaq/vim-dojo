...
export const visualChallenges: Challenge[] = [
  ...
  },
  {
    ...
    description: 'Change the three 0 flags to 1 in one visual-block replace.',
    category: 'visual',
    difficulty: 'hard',
    initialContent: ['timeout: 0,', 'retries: 0,', 'workers: 0,'].join('\n'),
    targetContent: ['timeout: 1,', 'retries: 1,', 'workers: 1,'].join('\n'),
    initialCursor: { line: 0, column: 9 },
    concepts: ['Ctrl-v', 'r'],
    hints: [
      'The cursor starts on the first 0. The other two sit in the same column.',
      'Enter Visual-Block, extend down the column, then replace the character.',
      'Try `<C-v>jjr1`.',
    ],
    intendedMove: '<C-v>jjr',
  },
  {
    id: 'visual-09',
    title: 'Delete two visual lines',
    description: 'Visually select unused and leftover, then delete both lines.',
    category: 'visual',
    difficulty: 'medium',
    initialContent: [
      'function start() {',
    ...
    concepts: ['V', 'j', 'd'],
    hints: [
      'Two whole lines should go away, not just one.',
      'Enter Visual-Line, extend down, then delete the selection.',
      'Try `Vjd`.',
    ],
    intendedMove: 'Vjd',
  },
