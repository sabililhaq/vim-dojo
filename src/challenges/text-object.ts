...
export const textObjectChallenges: Challenge[] = [
  ...
  },
  {
    ...
    description: 'Delete everything inside the parentheses, leaving connect().',
    category: 'text-object',
    difficulty: 'easy',
    initialContent: 'connect(host, port, true);',
    targetContent: 'connect();',
    initialCursor: { line: 0, column: 8 },
    concepts: ['di(', 'text-object'],
    hints: [
      'The cursor starts inside the call arguments.',
      'Delete the contents inside the parentheses, keep the parentheses.',
      'Try `di(`.',
    ],
    intendedMove: 'di(',
  },
  {
    ...
    description: 'Remove the quoted role value, including the quotes.',
    category: 'text-object',
    difficulty: 'easy',
    initialContent: 'role: "admin",',
    targetContent: 'role: ,',
    initialCursor: { line: 0, column: 7 },
    concepts: ['da"', 'text-object'],
    hints: [
      'The cursor starts inside the quotes.',
      'Delete the quotes and the text they wrap.',
      'Try `da"`.',
    ],
    intendedMove: 'da"',
  },
