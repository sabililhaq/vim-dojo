...
Need search, counts, macros, or replace? Add a new file next to those, export an array, register it in `src/challenges/index.ts`, and add the category to `src/challenges/types.ts`.
